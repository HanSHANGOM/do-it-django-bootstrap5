...
class TestView(TestCase):
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.category_fuka.name,post_area.text)
    ...
    def test_category_page(self):
        response = self.client.get(self.category_fuka.get_absolute_url())
        self.assertEqual(response.status_code,200)
        ...
        self.assertIn(self.category_fuka.name, soup.h1.text)

        main_area = soup.find('div',id = 'main-area')
        self.assertIn(self.category_fuka.name, main_area.text)
